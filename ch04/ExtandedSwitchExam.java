...
public class ExtandedSwitchExam {
	// 향상된 switch문 -> 람다식 결합
	// 메서드를 나누는 연습(main메서드는 주 실행용, 나머지 메서드는(CRUD동작용)
	...
	// 주메뉴	
		...
		System.out.println("찾은 동물의 이름을 입력하세요 >>>");
	...
	static String whoIsItReturn(String Monster) { //아래쪽에서 만든 메서드를 호출
	...
	static void whoIsIt(String Monster) { // 호출당함(매개값) -> 매개값은 타입만 맞으면 됨 여기선 String
