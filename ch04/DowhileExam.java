...
public class DowhileExam {
	...
	public static void main(String[] args) {
		...
		int click = 0; // 시도한 횟수
		int answer = (int) (Math.random() * 3) + 1; // 컴퓨터가 랜덤 숫자를 생성한다.(1~50)
		...
		if (click == 3) {
			...
			System.out.println("3번의 시도로 성공하셔서 3등 경품을 드립니다.");
		} else if (click == 2) {
			System.out.println("정답입니다. " + answer + "당신이 시도한 횟수는 : " + click);
			System.out.println("2번의 시도로 성공하셔서 2등 경품을 드립니다.");
		} else if (click == 1) {
			System.out.println("정답입니다. " + answer + "당신이 시도한 횟수는 : " + click);
			System.out.println("1번의 시도로 성공하셔서 1등 경품을 드립니다.");
		} else {
