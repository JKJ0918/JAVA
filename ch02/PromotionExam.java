...
import java.util.Scanner; // import : 다른 패키지에 있는 코드를 가져옴.
...
public class PromotionExam {
	...
	public static void main(String[] args) {
		...
		//키보드로 점수를 입력받는 곳
		Scanner input = new Scanner(System.in) ; // 키보드로 입력 받는 객체 생성 암기, new : 변수
		System.out.print("국어 점수 : ");
		kor = input.nextByte(); // Scanner 객체에서 키보드로 입력받은 값을 byte로 처리
		...
		if(avg >= 60) {
			...
			System.out.println("현재 점수 : " + avg );
			System.out.println("불합격 점수 : 60점 미만");
