...
public class ArithmeticExam {
	...
	public static void main(String[] args) {
		// 이항 연산자는 2개의 항으로 계산 되어 결과를 산출한다.
		// 사칙연산 + 나머지계산 등에 활용
		...
		int result4 = v1 / v2 ;
		System.out.println("result4 = " + result4); // 몫 2 
		...
		double result7 = (double) v1 / v2 ; // 강제타입변환 + 자동타입변환 활용 *자동 타입 변환으로 v2는 안해줘도됨
		...
		//사과 1개를 0.1단위인 10조각으로 보고(piece) 그중 7개의 조각(0.7)을 뺀 3조각(0.3) 계산
		...
		System.out.println("==================축약 기법====================");
		
		int appleInt = 1 ; // 사과 1개
		int totalPieces = appleInt * 10 ; // 10등분으로 나누지 말고 곱
		int number = 7 ;
		int temp = totalPieces - number ; // 사과 10조각을 -7 조 = 3조각
