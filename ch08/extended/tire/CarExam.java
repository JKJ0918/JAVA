...
public class CarExam {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= 30; i++) {
			...
			case 1:
				System.out.println("============================");
				System.out.println("앞 왼쪽 타이어가 펑크!!");
				System.out.println("1.한국타이어, 2.금호타이어, 3.OEM 타이어");
				System.out.print(">>>");
			...
			case 2:
				System.out.println("============================");
				System.out.println("앞 오른쪽 타이어가 펑크!!");
				System.out.println("1.한국타이어, 2.금호타이어, 3.OEM 타이어");
				System.out.print(">>>");
			...
			case 3:
				System.out.println("============================");
				System.out.println("뒤 왼쪽 타이어가 펑크!!");
				System.out.println("1.한국타이어, 2.금호타이어, 3.OEM 타이어");
				System.out.print(">>>");
